...
--       -- Quit xmonad
--       -- 1 ((modm .|. shiftMask, xK_q), spawn "rofi -show power-menu -modi power-menu:rofi-power-menu"),
--       -- ((modm .|. shiftMask, xK_q), io exitSuccess),
--       -- Restart xmonad
--       -- 1 ((modm, xK_q), spawn "xmonad --recompile; xmonad --restart"),
